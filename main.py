...
def main():
    ...
    """
    # load vote data
    c_votes = load_data(r'C:\Users\alexd\Chi Square Python\Clinton_Illinois.txt')
    j_votes = load_data(r'C:\Users\alexd\Chi Square Python\Johnson_votes_Illinois.txt')
    s_votes = load_data(r'C:\Users\alexd\Chi Square Python\Stein_votes_Illinois.txt')
    t_votes = load_data(r'C:\Users\alexd\Chi Square Python\Trump_votes_Illinois.txt')
    ...
    print("\nCandidate winning target = {:,} votes".format(t_target))
    ...
    for i in range(0, len(t_votes)):
        print("old Trump: {} \t new Trump: {} \t old Biden: {} \t " \
              "new Biden: {}". format(t_votes[i], new_t_votes[i], c_votes[i], new_c_votes[i]))
        print("-" * 95)
        print("TOTALS:")
        print("old Trump: {:,} \t new Trump: {:,} \t old Biden: {:,}  " \
          "new Biden: {:,}".format(sum(t_votes), sum(new_t_votes),
    ...
    with open('fake_Georgia_counts.txt', 'w') as f:
...
# C:\Users\alexd\Chi Square Python\Jorgensen_Georgia_2020.txt
# C:\Users\alexd\Chi Square Python\Biden_Georgia_2020.txt
# C:\Users\alexd\Chi Square Python\Trump_Georgia_2020.txt
# C:\Users\alexd\Chi Square Python\Dummy_Georgia.txt

# C:\Users\alexd\Chi Square Python\Clinton_Illinois.txt
# C:\Users\alexd\Chi Square Python\Trump_votes_Illinois.txt
# C:\Users\alexd\Chi Square Python\Stein_votes_Illinois.txt
# C:\Users\alexd\Chi Square Python\Johnson_votes_Illinois.txt